...
def get_daily_kline(client, code, start_date, end_date, use_adj=False):
    """
    获取日K线数据
...
def main():
    ...
    parser.add_argument('--use-adj', action='store_true', help='使用后复权价格')
    ...
    try:
        ...
        df = get_daily_kline(client, args.code, start_date, end_date, use_adj=args.use_adj)
        ...
        # 绘制K线图
        adj_text = "（后复权）" if args.use_adj else ""
